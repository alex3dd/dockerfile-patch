...
templates, customized with a Docker image facts gatherer (supported facts:
osfamily, operatingsystem, kernelrelease and architecture). You can use the
system facts to customize the Jinja2 patches applied to your Dockerfiles.
